...
const PeercamViewer = forwardRef<LiveViewerRefType, LiveStreamViewerProps>(({ screenCode }, ref) => {
...
PeercamViewer.displayName = 'PeerCamViewer';

export default PeercamViewer;